...
- Erarbeitung ausgehend von der Übung
  1. Bearbeitung der Übung bis man nicht mehr weiter kommt
  2. Einen Teil der Vorlesung bearbeiten
  3. Weitere Bearbeitung der Übung
  4. ...
...
- Programmierung einzelner Verfahren
:::
:::
...
- Bereitschaft Rückmeldung (*Feedback*) zu geben und die Veranstaltung aktiv
  mitzugestalten
...
- Python (Versionen 3.6, 3.7 und 3.12) ![](assets/einf-python.png){height="50"}
- FiPy @www_fipy ![](assets/einf-jupyter.png){height="50"}
- Jupyter @www_jupyter ![](assets/einf-fipy.png){height="50"}
...
- Beim Hub unter www.jupyterhub.ihs.uni-stuttgart.de muss der Benutzer
  erst angelegt werden.
- Der Hub unter hub.bwjupyter.de wird vom KIT betrieben; dort können Sie sich
  mit Ihrem *st123456* Account anmelden.

## Jupyterhub
### Startseite www.ihs.uni-stuttgart.de
...
## Jupyterhub
### Startseite hub.bwjupyter.de

![](assets/einf-jupyter-22.5.png){fig-align="center" .r-stretch}

- Das korrekte Abbild bekommen Sie über den Link im ILIAS-Kurs 
- Nachdem das korrekte Profil (*docker* Abbild) geladen ist, sehen Sie die 
  Startseite
...
- Durch Anklicken des Namens, können Sie diesen ändern.
- Zellen werden mit Quelltext befüllt und durch `Shift` + `Enter` ausfegührt.
...
der Fehler ganz unten. Der obere Teil enhält meist ein *Backtrace* und listet
